...
0x02ff15D0 = bla _BOTW_RawStamina_UpdateInventoryYellowStamina # Same area as above [lfs f12, +0x1d34(r31)]
...
0x02fe1784 = bla _BOTW_RawStamina_LimitInventoryYellowStaminaPreview # Same area as above [bge 0x02fe17cc]
...
0x02D90CD0 = bla _BOTW_RawStamina_UpdateStamina # Same area as above [fadds f13, f12, f29]
