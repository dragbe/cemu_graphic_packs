...
- Max food slots count = 60 by default (editable in patch_patches.asm|patches.txt with some limitations)
- Max uncooked foods count per slot = 999 by default (editable in patch_patches.asm|patches.txt)
