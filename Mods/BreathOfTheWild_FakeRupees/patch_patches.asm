...
bnelr # if (FakeRupeeActorName.substr(3,2)!="An") EXITSUB
li r3, $BombsNumGameDataPointerOffset
b _BOTW_FakeRupees_UpdateFakeRupeeSaveData

#0x02B769DC = bl 0x02B621E4 To be considered as isRupeeItem
0x02B7657C = bla _BOTW_FakeRupees_RupeeUpdateOnLoot # Rupee update on loot [mr r31, r3]
...
#0x02B76578 = bgt .+0xC # if (RupeeValue>$VanillaMaxRupeeValue) GOTO lwzxu r6, r12, r3 [stw r31, +0xC(r1)]
#0x02B7657C = lwzu r6, 0x54(r12) # [mr r31, r3]
#0x02B76580 = b .+0x14 # GOTO lwz r5, 0x14(r6) [stw r0, +0x14(r1)]
#0x02B76584 = lwzxu r6, r12, r3 # [li r3, 1]
