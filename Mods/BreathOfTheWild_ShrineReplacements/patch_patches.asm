...
0x030595B8 = lwz r9, 0x4(r17) # Same area as above [lwz r9, +0x4(r25)]
0x030595C4 = mr r3, r17 # Same area as above [mr r3, r25]
0x030595D0 = mr r30, r23 # Same area as above [li r30, 1]
