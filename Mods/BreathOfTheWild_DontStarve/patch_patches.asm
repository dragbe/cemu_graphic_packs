...
0x02d8fbe8 = bgt .+0x134 # [lwz r0, +0x664(r12)]
0x02d8fbec = lwz r0, 0x664(r12) # [mtctr r0]
0x02d8fbf0 = mtctr r0 # [mr r3, r31]
...
0x02D8FC64 = lfs f11, _BOTW_DontStarve_HeartAutoRecoverIntervalMax@l(r10) # [lfs f11, +0x20C(r10)]
# Warning: 0x02D8FC4C = cmplwi r0, 0x15 always false ???
0x02D8FCF4 = lis r12, 0x1000 # Apply heart auto recover area [lwz r12, +0x0(r10)]
0x02D8FCFC = lfs f11, 0x05F0(r12) # [lfs f11, +0x1ec(r12)]
